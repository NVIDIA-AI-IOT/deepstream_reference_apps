...
```
    docker run --gpus all -it  --ipc=host --rm -v /tmp/.X11-unix:/tmp/.X11-unix  -v $(pwd):/samples   -e DISPLAY=$DISPLAY -w /samples gitlab-master.nvidia.com:5005/deepstreamsdk/release_image/deepstream:6.2.1-triton-23.03.1
```
